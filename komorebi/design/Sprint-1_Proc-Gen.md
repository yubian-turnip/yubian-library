...
2. Find the vectors: $\hat{r}_i = \left[ \cos(\theta_i), \sin(\theta_i) \right]$
...
but... it turns out all that is highly ineffective and inefficient. The radial sampling I'm doing above is good for finding local maxima, tracing uphill/downhill paths, erosion and rivers but not really for tracing mountains. 

Even still gradients won't work because they all point to the peak not the ridges or spines of the mountains. 

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMzNzY4NzkxNywtMjA5MjQwNzUsMTUwNz
