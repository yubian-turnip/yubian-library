...
4. Find the average of the rays: $P= [\bar{p}_1,\bar{p}_2,\bar{p}_3...\bar{p}_n] , \bar{P} =\frac{1}{n}\sum_{i = 1}^{n}P_i$
5. Add $\bar{P}$ to the center point
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIyOTI2Mjg2MiwxOTgyMjY5MTI0LC0xMj
